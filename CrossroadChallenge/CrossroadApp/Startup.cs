...
namespace CrossroadApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<TitlesContext>( //Change your connection string in appsettings.json
                options => options.UseSqlServer(Configuration.GetConnectionString("TitleDB")));
        }
